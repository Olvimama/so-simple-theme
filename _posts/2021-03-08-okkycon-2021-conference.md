...
1. 키노트: "커뮤니케이션이란 무엇인가? 어떻게 해야 효과적으로 협업을 할 수 있는가?" (박태웅 / 한빛미디어 의장)
2. 세션: "협력의 조건 만들기" (홍영기 / 네오위즈 애자일 코치)
3. 세션: "함께 성장하고 협업하는 문화를 만들어가는 과정" (박재성 / 우아한형제들 교육이사)
4. 세션: "당신에게 협업의 대상은 누구인가요?" (김영욱 / SAP senior program manager)
5. 세션: "프로덕트 조직의 생산성 높이기" (김영재 / 라인플러스 Fellow)
6. 세션: "OKR 기반으로 스케일업 가능한 협업 체계 만들기" (이동주 / 번개장터 CTO)
7. 세션: "7년간 방치되었던 쏘카의 가격시스템, 직접 개발해버린 이야기" (김상우 / 쏘카 데이터그룹 그룹장)
8. 세션: "당근마켓 성장에 따른 협업의 변화는 진행 중" (정창훈 / 당근마켓 CTO)
